...
namespace MOARANDROIDS
{
    ...
    public class MechFall : OrbitalStrike
    {
        ...
        public override void Tick()
        {
            ...
            if (base.TicksPassed == this.duration - 170)
            {
                this.CreatePod();
            }
            base.Tick();
        ...
        private void CreateExplosion()
        {
            ...
            ThingDef weaponDef = this.weaponDef;
                GenExplosion.DoExplosion(base.Position, base.Map, 1, smoke, instigator, -1, null, weaponDef, def, null, 0f, 1, false, null, 0f, 1, 0f, false);
            GenExplosion.DoExplosion(base.Position, base.Map, 1, DamageDefOf.Bomb, instigator, -1, null, weaponDef, def, null, 0f, 1, false, null, 0f, 1, 0f, false);
        }
        ...
        public void SpawnDude()
        {
            ...
            FilthMaker.MakeFilth(base.Position, base.Map, RimWorld.ThingDefOf.SlagRubble, 30);
