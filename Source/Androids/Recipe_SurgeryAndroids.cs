...
namespace MOARANDROIDS
{
    ...
    public class Recipe_SurgeryAndroids : RecipeWorker
    {
        ...
        {
            float num = 0.75f;
            num *= surgeon.GetStatValue((!patient.RaceProps.IsMechanoid) ? StatDefOf.ResearchSpeed : StatDefOf.MechanoidOperationSuccessChance, true);
            if (patient.InBed())
            {
                num *= patient.CurrentBed().GetStatValue(StatDefOf.MechanoidOperationSuccessChance, true);
            }
